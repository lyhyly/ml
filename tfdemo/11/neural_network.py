...
"""
def train1(X_train, Y_train, X_test, Y_test, n_hidden_nodes, iterations, lr):
    #训练样本列数
    ...
    return train2(X_train, Y_train, X_test, Y_test,w1, w2, n_hidden_nodes, iterations, lr)

def train2(X_train, Y_train, X_test, Y_test,w1, w2, n_hidden_nodes, iterations, lr):
    accuracy = 0
    #迭代训练
...
st = time.time()
w1,w2,accuracy1 = train1(mnist.X_train,mnist.Y_train, mnist.X_test, mnist.Y_test, n_hidden_nodes=200,iterations=10000, lr=0.01)
end = time.time()
w1,w2,accuracy2 = train2(mnist.X_train,mnist.Y_train, mnist.X_test, mnist.Y_test,w1,w2, n_hidden_nodes=200,iterations=10000, lr=0.01)
print("train1耗时：%.5f,准确率：Accuracy: %.2f%%" % (end-st, accuracy1))
print("train2耗时：%.5f,准确率：Accuracy: %.2f%%" % (time.time()-end, accuracy2))
